package com.alibado.util
{
    ...
    */
    public interface ICollectionList
    {
        ...
        * @return 若是有数据被插入则返回true，否则返回false
        */
        function addAll(items:ICollectionList):Boolean;
         ...
         * @return 若是有数据被插入则返回true，否则返回false
         */
        function addAllAt(items:ICollectionList, i:uint):Boolean;
        ...
        * @return 返回测试结果
        */
        function containsAll(items:ICollectionList, and:Boolean):Boolean;
        ...
        * @return 被删除的元素个数
        */
        function retainAll(items:ICollectionList):uint;
        ...
        * @return 返回测试结果
        */
        function equals(other:ICollectionList):Boolean;
        ...
        * @return 删除元素的个数
        */
        function removeAll(items:ICollectionList):uint;
